// packages/ir/src/edit/operations/script-block-creation-content.ts
...
export type ScriptBlockCreationBindingDescriptorV1 = Without<
  ScriptBlockFutureContractBindingV1,
  'bindingKey' | 'expectedCreationContentFingerprintSha256'
>

interface ScriptBlockCreationResultRoleV1
{
...
export type ScriptBlockCreationOperationV1 =
  | SemanticEditOperationScriptAddV1
  | SemanticEditOperationScriptDuplicateV1
  | SemanticEditOperationBlockInsertBeforeV1
  | SemanticEditOperationBlockInsertAfterV1
...
interface ScriptBlockSelectedCreationSourceV1
{
...
export type ScriptBlockContractEntityResolutionRequestV1 =
...
{
  readonly operation: ScriptBlockCreationOperationV1
  readonly descriptor: ScriptBlockCreationBindingDescriptorV1
  readonly resultRole: ScriptBlockCreationResultRoleV1
  readonly selectedSource: ScriptBlockSelectedCreationSourceV1
}
...
function expectedEntityKind(
  subtype: string
): ScriptBlockContractReferenceExpectationV1['expectedEntityKind']
{
  ...
  if (descriptorField.requiredEntitySubtype !== null)
  {
    ...
    return {
      ...
      value: resolveContractRef(state.input, {
        ...
        expectedEntityKind: 'declaration',
        expectedEntitySubtype:
          descriptorField.requiredEntitySubtype as ScriptBlockContractReferenceExpectationV1['expectedEntitySubtype'],
...
function resultAlias(input: ScriptBlockCreationContentInputV1): string
{
...
function authoredRootValue(operation: ScriptBlockCreationOperationV1): unknown
{
...
function assertOperationRole(input: ScriptBlockCreationContentInputV1): void
{
  ...
  const roles: Readonly<
    Record<ScriptBlockCreationOperationV1['kind'], readonly string[]>
  > = {
...
function assertCreationScope(input: ScriptBlockCreationContentInputV1): void
{
  const { operation, descriptor, resultRole } = input
...
function scriptBlockCreationContentProjectionForResultV1(
  input: ScriptBlockCreationContentInputV1
): unknown
{
...
export function scriptBlockCreationContentFingerprintForResultV1(
  input: ScriptBlockCreationContentInputV1
): string
{
  return semanticHashV1(
    'semantic-fingerprint',
    scriptBlockCreationContentProjectionForResultV1(input)
  )
}
