// packages/ir/src/edit/semantic-index/reference-index-types.ts
...
import type { ProcedureWarpEncoding } from './procedure-mutation.js'
...
{
  return JSON.stringify([target.targetIndex])
}
