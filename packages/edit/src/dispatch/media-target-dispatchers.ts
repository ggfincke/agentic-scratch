// packages/edit/src/dispatch/media-target-dispatchers.ts
...
import {
  ...
  type MediaTargetCreationOperationV1,
  type MediaTargetCreationResultRoleV1,
...
type MediaTargetOperationV1 = CostumeOperationV1 | SoundOperationV1
...
interface MediaTargetProductionOperationResultV1
{
...
interface MediaTargetPlanningFactProjectionV1
{
  readonly kind: 'group-f-media-planning-fact-set'
  readonly schemaVersion: 1
  readonly operationKind: MediaTargetOperationV1['kind']
  readonly opId: string
...
interface ResolvedMediaTargetDispatchV1
{
  readonly operation: MediaTargetOperationV1
  readonly canonicalOperation: MediaTargetOperationV1
...
interface ResultBindingMatchV1
{
  ...
  readonly slot: ProductionResultSlotV1
...
function mediaKindOf(operation: MediaTargetOperationV1): 'costume' | 'sound'
{
...
function mediaTargetPlanningFactProjection(
  resolved: ResolvedMediaTargetDispatchV1
...
interface MediaTargetPlanningCompletionV1<
...
export function productionMediaTargetAddCostumePlanningCompletionV1(
  context: ProductionOperationContextV1,
  goal: Extract<
    SemanticEditOperationGoalV1,
    { readonly kind: 'media.addCostume' }
  >
): MediaTargetPlanningCompletionV1<SemanticEditOperationMediaAddCostumeV1>
{
  ...
  const planningFactSetSha256 = productionMediaTargetPlanningFactSetSha256V1(
    context,
    operation
  )
...
export function productionMediaTargetSpritePlanningCompletionV1(
  context: ProductionOperationContextV1,
  goal: Extract<
    SemanticEditOperationGoalV1,
    { readonly kind: 'target.addSprite' }
  >
): MediaTargetPlanningCompletionV1<
...
export function productionMediaTargetMediaPlanningCompletionV1(
  context: ProductionOperationContextV1,
  goal: Extract<
    SemanticEditOperationGoalV1,
...
): EditOperationPlanningResultV1
{
  ...
  let operation: MediaTargetOperationV1
  ...
  else
  {
    ...
    )
    {
      ...
      if (goal.kind === 'media.reorderCostume')
      {
        ...
        facts = Object.freeze([
          completedPlanningFactV1('/expectedIndex', 'integer', expectedIndex),
          completedPlanningFactV1(
            '/expectedMediaOrderSha256',
            'sha256',
            expectedMediaOrderSha256
    ...
    )
    {
      ...
      if (goal.kind === 'media.removeCostume')
      {
        ...
        facts = Object.freeze([
          ...
          completedPlanningFactV1('/requireFinalReferenceCount', 'integer', 0),
          completedPlanningFactV1('/expectedCurrentCostume', 'boolean', false),
          completedPlanningFactV1(
...
function resolveMediaTargetDispatch(
  context: ProductionOperationContextV1,
  operation: MediaTargetOperationV1
): ResolvedMediaTargetDispatchV1
{
...
function mediaTargetCreationRoleForSlot(
  slot: ProductionResultSlotV1
): MediaTargetCreationResultRoleV1
{
...
function matchResultBindings(
  context: ProductionOperationContextV1,
  operation: MediaTargetOperationV1,
  slots: readonly ProductionResultSlotV1[],
...
): readonly ResultBindingMatchV1[]
{
  return Object.freeze(
    slots.map((slot) =>
    {
      const role = mediaTargetCreationRoleForSlot(slot)
...
): string
{
  ...
  return mediaTargetCreationContentFingerprintForResultV1({
    project: sourceProject,
    targetIndex: resolved.targetIndex,
    operation: resolved.canonicalOperation as MediaTargetCreationOperationV1,
    descriptor: binding,
    resultRole: mediaTargetCreationRoleForSlot(slot),
    resolveContractEntityRef: (request) =>
      resolveMediaTargetContractEntityReference(sourceContext, request),
  })
}
...
function resolveMediaTargetContractEntityReference(
  context: ProductionOperationContextV1,
  request: {
...
function mediaTargetPropertyAllowed(
...
): ContractScopeV1
{
  ...
  const matches = context.contract.allowedSemanticScopes.filter((scope) =>
  {
    if (
      ...
      !mediaTargetPropertyAllowed(scope, operation)
    )
      return false
...
function mediaTargetOperationResult(
...
): MediaTargetProductionOperationResultV1
{
...
function executeResolvedMediaTargetOperation(
  context: ProductionOperationContextV1,
  resolved: ResolvedMediaTargetDispatchV1,
  planningFactProjection: MediaTargetPlanningFactProjectionV1
): ProductionOperationDispatchResultV1
{
  ...
  return {
    ...
    selectedScope,
    result: mediaTargetOperationResult(
...
class CostumeMediaProductionOperationDispatcherV1 implements ProductionOperationDispatcherV1
{
  ...
  ): ProductionOperationDispatchResultV1
  {
    ...
    const resolved = resolveMediaTargetDispatch(
      context,
      operation as CostumeOperationV1
    )
    return executeResolvedMediaTargetOperation(
      context,
      resolved,
      mediaTargetPlanningFactProjection(resolved)
    )
  }
}
...
interface MediaTargetSpritePlanningFactProjectionV1
{
...
): MediaTargetSpritePlanningFactProjectionV1
{
...
export function productionMediaTargetSpritePlanningFactSetSha256V1(
  context: ProductionOperationContextV1,
  operation: TargetCreationOperationV1
): string
{
...
class SpriteCreationProductionOperationDispatcherV1 implements ProductionOperationDispatcherV1
{
  ...
  ): ProductionOperationDispatchResultV1
  {
    ...
    const slot: ProductionResultSlotV1 = {
      slotKind: 'fixed',
      name: 'target',
      entityKind: 'target',
    ...
    const binding = matchSpriteResultBinding(
      ...
      (candidate) =>
        mediaTargetCreationContentFingerprintForResultV1({
          ...
          operation: operation as MediaTargetCreationOperationV1,
          descriptor: candidate,
          resultRole: { roleKind: 'fixed', name: 'target' },
          resolveContractEntityRef: (request) =>
            resolveMediaTargetContractEntityReference(
...
export function mediaTargetProductionOperationDispatchersV1(): readonly ProductionOperationDispatcherV1[]
{
  return Object.freeze([
