// packages/edit/src/dispatch/group-d-dispatchers.ts
...
import {
  ...
  type GroupDCreationOperationV1,
...
import {
  canonicalGroupEParameterRefV1,
  canonicalGroupEProcedureRefV1,
  groupEParameterLineageInV1,
  groupEProcedureRecordAtV1,
  groupEProcedureSignatureStateSha256V1,
  planningGroupEParameterV1,
  planningGroupEProcedureV1,
  resolveGroupEParameterSelectionV1,
  resolveGroupEProcedureSelectionV1,
...
type GroupDOperationV1 = ScriptGroupDOperationV1 | BlockGroupDOperationV1
...
interface GroupDPlanningFactProjectionV1
{
  readonly kind: 'group-d-graph-planning-fact-set'
  readonly schemaVersion: 1
  readonly operationKind: GroupDOperationV1['kind']
...
{
  readonly operation: ScriptGroupDOperationV1
  readonly canonicalOperation: ScriptGroupDOperationV1
...
{
  readonly operation: BlockGroupDOperationV1
  readonly canonicalOperation: BlockGroupDOperationV1
...
{
  readonly binding: GroupDFutureContractBindingV1
  readonly slot:
...
}
{
  ...
  {
    const procedure = resolveGroupEProcedureSelectionV1(
      context,
      destination.procedure
    )
    assertSameTarget(targetIndex, procedure.current.targetIndex, 'block move')
    const parameter = resolveGroupEParameterSelectionV1(
      planning,
    ...
    const planningRecord = groupEProcedureRecordAtV1(
      planning.candidate,
      planningTargetIndex,
      procedure.canonical.proccode
    )
    const currentRecord = groupEProcedureRecordAtV1(
      context.candidate,
      targetIndex,
    ...
    const parameterLineageId = groupEParameterLineageInV1(
      context.activeLineage,
      procedure.lineageId,
      parameter.argumentId
    ).lineageId
    return {
      canonical: {
        ...
        procedure: canonicalGroupEProcedureRefV1(
          destination.procedure,
          procedure.canonical
        ),
        parameter: canonicalGroupEParameterRefV1(
          destination.parameter,
          parameter
        ),
      },
      ...
      planningEntities: Object.freeze([
        ...
        planningGroupEProcedureV1(procedure.canonical),
        planningGroupEParameterV1(parameter),
      ]),
      ...
      facts: {
        ...
        procedure: planningGroupEProcedureV1(procedure.canonical),
        parameter: planningGroupEParameterV1(parameter),
        argumentId: parameter.argumentId,
        actualSignatureSha256:
          groupEProcedureSignatureStateSha256V1(planningRecord),
      ...
      procedureArgumentGuard: {
        actualSignatureSha256:
          groupEProcedureSignatureStateSha256V1(currentRecord),
        expectedSignatureSha256: destination.expectedSignatureSha256,
      },
    }
  }
...
function resolveScriptDispatch(
  context: ProductionOperationContextV1,
  operation: ScriptGroupDOperationV1
...
function blockPrimaryReference(operation: BlockGroupDOperationV1): BlockRefV1
{
  if (
...
function blockClosurePlan(
  context: ProductionOperationContextV1,
  operation: BlockGroupDOperationV1,
...
function productionGroupDPlanningFactProjectionV1(
  context: ProductionOperationContextV1,
  operation: GroupDOperationV1
): GroupDPlanningFactProjectionV1
{
  const resolved = operation.kind.startsWith('script.')
    ? resolveScriptDispatch(context, operation as ScriptGroupDOperationV1)
    : resolveBlockDispatch(context, operation as BlockGroupDOperationV1)
  return {
...
export function productionGroupDPlanningFactSetSha256V1(
  context: ProductionOperationContextV1,
  operation: GroupDOperationV1
): string
{
...
export function productionGroupDPlanningCompletionV1(
  context: ProductionOperationContextV1,
  goal: Extract<
...
{
  let operation: GroupDOperationV1
  ...
  const planningFactSetSha256 = productionGroupDPlanningFactSetSha256V1(
    context,
    operation
  )
...
export function productionGroupDChoicePlanningCompletionV1(
  context: ProductionOperationContextV1,
  goal: Extract<
    SemanticEditOperationGoalV1,
    {
...
function groupDPropertyAllowed(
...
): ContractScopeV1
{
  ...
  const matches = context.contract.allowedSemanticScopes.filter((scope) =>
  {
    if (
      ...
      !groupDPropertyAllowed(scope, operation)
    )
      return false
    if (scope.locationScope.scopeKind === 'exactEntity')
...
function creationRoleForSlot(
  slot: GroupCProductionResultSlotV1 | ProductionDynamicBlockResultSlotV1
): {
...
function futureBindingScopeMatches(
  binding: GroupDFutureContractBindingV1,
  ...
  return Object.freeze(
    results.map((slot) =>
    {
      ...
      const matches = context.contract.entityBindings
        .filter(
          (binding): binding is GroupDFutureContractBindingV1 =>
            binding.bindingKind === 'future' &&
...
function rawDeclarationEvidence(
  context: ProductionOperationContextV1,
  request: Extract<
    GroupDContractEntityResolutionRequestV1,
...
): string
{
  ...
  return groupDCreationContentFingerprintForResultV1({
    project: sourceProject,
    targetIndex: resolved.targetIndex,
    operation: resolved.canonicalOperation as GroupDCreationOperationV1,
    descriptor: binding,
...
function executeResolvedGroupDOperation(
  context: ProductionOperationContextV1,
  resolved: ResolvedScriptDispatchV1 | ResolvedBlockDispatchV1,
  planningFactProjection: GroupDPlanningFactProjectionV1
): ProductionOperationDispatchResultV1
{
  ...
  const slots =
    'createdTopBlockId' in applied
      ? collectScriptResultSlots(
          context,
          operation as ScriptGroupDOperationV1,
          resolved.targetIndex,
          resolved.targetLineageId,
...
class ScriptStructuralProductionOperationDispatcherV1 implements ProductionOperationDispatcherV1
{
  ...
  ): ProductionOperationDispatchResultV1
  {
    ...
    const scriptOperation = operation as ScriptGroupDOperationV1
    ...
    return executeResolvedGroupDOperation(
      context,
      resolved,
      planningFactProjection
    )
...
class BlockStructuralProductionOperationDispatcherV1 implements ProductionOperationDispatcherV1
{
  ...
  ): ProductionOperationDispatchResultV1
  {
    ...
    const blockOperation = operation as BlockGroupDOperationV1
...
export function groupDProductionOperationDispatchersV1(): readonly ProductionOperationDispatcherV1[]
{
  return Object.freeze([
