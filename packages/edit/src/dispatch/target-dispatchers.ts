// packages/edit/src/dispatch/target-dispatchers.ts
...
type ProcedureOperationV1 = Extract<
  SemanticEditOperationV1,
  { kind: `procedure.${string}` }
>

type MediaTargetOperationV1 = Extract<
  SemanticEditOperationV1,
  { kind: `media.${string}` }
>
...
export interface ProductionResultSlotV1
{
...
export interface ProductionOperationResultV1
{
...
export interface PlanningEntityProjectionV1
{
  readonly entityKind:
    | 'target'
    | 'declaration'
...
interface DeclarationPlanningFactProjectionV1
{
  readonly kind: 'group-c-declaration-planning-fact-set'
  readonly schemaVersion: 1
  readonly operationKind: DeclarationOperationV1['kind']
  readonly opId: string
  readonly selectedTarget?: PlanningEntityProjectionV1
  readonly selectedDeclaration?: PlanningEntityProjectionV1
  readonly selectedLineageIds: readonly string[]
  readonly facts: unknown
}

interface CommentPlanningFactProjectionV1
{
  ...
  readonly opId: string
  readonly selectedTarget?: PlanningEntityProjectionV1
  readonly selectedComment?: PlanningEntityProjectionV1
  readonly selectedBlock?: PlanningEntityProjectionV1
  readonly selectedLineageIds: readonly string[]
  readonly facts: unknown
}

interface ScriptWorkspacePlanningFactProjectionV1
{
  readonly kind: 'group-c-script-workspace-planning-fact-set'
  readonly schemaVersion: 1
  readonly operationKind: 'script.moveWorkspace'
  readonly opId: string
  readonly selectedScript: PlanningEntityProjectionV1
  readonly selectedLineageIds: readonly string[]
  readonly facts: unknown
}

interface ConflictOperationProjectionV1
{
  readonly opId: string
  readonly operationKind: SemanticEditOperationV1['kind']
...
interface ConflictProofV1
{
  readonly kind: 'group-c-operation-conflict-proof'
  readonly schemaVersion: 1
  readonly operations: readonly ConflictOperationProjectionV1[]
  readonly pairwiseDecisions: readonly ConflictDecisionV1[]
...
function targetProductionResult(
  context: ProductionOperationContextV1,
  opId: string
): ProductionOperationResultV1
{
  ...
  return value as ProductionOperationResultV1
}
...
): ProductionResultSlotV1 | ProductionDynamicBlockResultSlotV1
{
  ...
  const result = targetProductionResult(context, reference.opId)
...
function priorCreatedSlotForLineage(
  ...
  entityKind: ProductionResultEntityKindV1,
  lineageId: string
): ProductionResultSlotV1 | ProductionDynamicBlockResultSlotV1 | null
{
  const matches: (
    ProductionResultSlotV1 | ProductionDynamicBlockResultSlotV1
  )[] = []
  for (const value of context.operationResultsById.values())
  {
    ...
    const dynamicSlots = (value as Partial<ProductionOperationResultV1>)
      .dynamicSlots
...
function productionDeclarationPlanningFactProjectionV1(
  context: ProductionOperationContextV1,
  operation: DeclarationOperationV1
): DeclarationPlanningFactProjectionV1
{
...
export class DeclarationProductionOperationDispatcherV1 implements ProductionOperationDispatcherV1
{
  ...
  ): ProductionOperationDispatchResultV1
  {
    ...
    )
    {
      futureBindings = futureBindingKeysForCreation(
        ...
        (binding) =>
        {
          ...
          return declarationCreationContentFingerprintV1(
            declarationOperation,
            binding
          )
        }
    ...
    let fixedSlots: readonly ProductionResultSlotV1[] = Object.freeze([])
...
function productionCommentPlanningFactProjectionV1(
  context: ProductionOperationContextV1,
  operation: CommentOperationV1
): CommentPlanningFactProjectionV1
{
    ...
    if (commentOperation.kind === 'comment.add')
    {
      ...
      futureBindings = futureBindingKeysForCreation(
        ...
        (binding) =>
        {
          ...
          return commentCreationContentFingerprintV1(
            commentOperation,
            binding,
...
function productionScriptWorkspacePlanningFactProjectionV1(
  context: ProductionOperationContextV1,
  operation: SemanticEditOperationScriptMoveWorkspaceV1
): ScriptWorkspacePlanningFactProjectionV1
{
...
function scriptBlockConflictResources(
  input: EditTransactionInputV1,
  project: ProjectIR,
  lineage: SemanticLineageSnapshot,
  operation: SemanticEditOperationV1,
...
function procedureConflictResources(
  input: EditTransactionInputV1,
  project: ProjectIR,
  lineage: SemanticLineageSnapshot,
  operation: ProcedureOperationV1,
...
): ConflictOperationProjectionV1
{
  ...
  if (operation.kind.startsWith('target.'))
    ...
    scriptBlockConflictResources(input, project, lineage, operation, projection)
  else if (operation.kind.startsWith('procedure.'))
    procedureConflictResources(
      input,
      project,
      lineage,
      operation as ProcedureOperationV1,
      projection
    )
    ...
    mediaConflictResources(
      ...
      project,
      lineage,
      operation as MediaTargetOperationV1,
      operations,
      projection
    )
  else
...
function conflictOverlap(
  left: ConflictOperationProjectionV1,
  right: ConflictOperationProjectionV1
): readonly string[]
{
...
): ConflictProofV1
{
  ...
  const decisions: ConflictDecisionV1[] = []
...
export function targetProductionOperationDispatchersV1(): readonly ProductionOperationDispatcherV1[]
{
  return Object.freeze([
