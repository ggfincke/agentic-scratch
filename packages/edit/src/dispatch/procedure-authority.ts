// packages/edit/src/dispatch/procedure-authority.ts
...
interface ProcedureSelectionV1
{
...
function procedureBoundedLocationV1(
...
): ProcedureRefV1
{
  return {
    ...
    location: procedureBoundedLocationV1(evidence),
...
export function canonicalProcedureRefV1(
...
): ProcedureRefV1
{
  return reference.refKind === 'created'
    ? reference
    : exactProcedureRefV1(evidence)
}

function parameterBoundedLocationV1(
...
export function exactParameterRefV1(
  evidence: ParameterEntityEvidenceV1
): ParameterRefV1
{
  return {
    ...
    refKind: 'structural',
    selectorKind: 'exactLocation',
    location: parameterBoundedLocationV1(evidence),
    expectedFullLocationSha256: evidence.semanticLocationSha256,
    expectedSemanticFingerprint: evidence.semanticFingerprintSha256,
    expectedContextFingerprint: evidence.contextFingerprintSha256,
  }
...
export function canonicalParameterRefV1(
...
): ParameterRefV1
{
  return reference.refKind === 'created'
    ? reference
    : exactParameterRefV1(evidence)
}

export function planningProcedureV1(
  evidence: ProcedureEntityEvidenceV1
): PlanningEntityProjectionV1
{
  return {
    ...
    boundedLocation: procedureBoundedLocationV1(evidence),
...
export function planningParameterV1(
  evidence: ParameterEntityEvidenceV1
): PlanningEntityProjectionV1
{
  return {
    entityKind: 'parameter',
    entitySubtype: 'unspecialized',
    boundedLocation: parameterBoundedLocationV1(evidence),
    semanticLocationSha256: evidence.semanticLocationSha256,
    semanticFingerprintSha256: evidence.semanticFingerprintSha256,
    contextFingerprintSha256: evidence.contextFingerprintSha256,
  }
...
export function procedureLineageInV1(
  project: ProjectIR,
...
export function parameterLineageInV1(
  lineage: SemanticLineageSnapshot,
...
export function procedureSignatureStateSha256V1(
...
export function procedureRecordAtV1(
  project: ProjectIR,
  targetIndex: number,
  proccode: string
): ProcedureRecordV1
...
export function resolveProcedureSelectionV1(
  context: ProductionOperationContextV1,
  reference: ProcedureRefV1
): ProcedureSelectionV1
{
  ...
  const lineageId = procedureLineageInV1(
    context.preBatch,
...
export function resolveParameterSelectionV1(
  context: ProductionOperationContextV1,
  reference: ParameterRefV1,
...
): ParameterEntityEvidenceV1
{
  ...
  if (reference.refKind === 'created')
  {
    ...
    const procedureLineageId = procedureLineageInV1(
      context.candidate,
      context.activeLineage,
